...
- Jangan komit file hasil olahan kecuali memang perlu.
- Gunakan virtual environment dan kernel yang disarankan untuk hasil yang konsisten.

## Lisensi

Repositori ini belum memiliki lisensi. Tambahkan file `LICENSE` jika ingin menetapkan ketentuan penggunaan.

## Kontak

Buka issue atau hubungi pemilik repositori untuk pertanyaan.
